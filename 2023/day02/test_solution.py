...
def test_part_1_example_should_be_8():
    report = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""
    assert sum_of_valid_games(report.splitlines()) == 8

def test_part1():
    report = []
    with open("input.txt") as f:
        report = f.readlines()
    assert sum_of_valid_games(report) == 1734

def test_part_2_example_should_be_2286():
    report = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""
    assert sum_of_powers_minimal_sets(report.splitlines()) == 2286

def test_part2():
    report = []
    with open("input.txt") as f:
        report = f.readlines()
    assert sum_of_powers_minimal_sets(report) == 70387
